...
function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-md border border-gray-300 space-y-8 rounded-3xl bg-gray-100 backdrop-blur-2xl p-10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-gray-900/5 [0_8px_30px_rgb(0,0,0,0.2)]">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900">
            Create an account
          </h2>
          <p className="mt-2 text-sm text-gray-600">
            Join us and start managing your learning
          </p>
        </div>
